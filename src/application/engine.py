...
class QueryEngine:
    ...
    def ingest_data(self, force_rebuild: bool = False) -> Dict[str, Any]:
        """Ingest journal data and build indexes."""
        ...
        # Generate embeddings
        embeddings = self.embedding_service.embed_entries(entries)

        # Store data
        self.metadata_store.add_entries(entries)
